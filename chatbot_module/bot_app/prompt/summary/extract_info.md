...
{{
  "candidate_overview": {{
    ...
    "current_title": "string | null - Chức danh hiện tại.",
    "applied_position": "string | null - Vị trí ứng tuyển. BẮT BUỘC đối chiếu với danh sách các vị trí đang mở: [{available_jobs}]. Ví dụ ứng viên nói 'sales', phải map về chuẩn 'Nhân viên bán hàng' có trong danh sách. Nếu không khớp vị trí nào, gán null.",
