...
from bot_app.graph.nodes import classify_user_intent, update_context
...
from bot_app.graph.summary.nodes import acknowledge_receipt
...
def build_main_graph():
    ...
    workflow.add_node("acknowledge_receipt", acknowledge_receipt)
    ...
    workflow.add_edge("acknowledge_receipt", "summary_subgraph")
    ...
    return workflow.compile(
        ...
        interrupt_before=["update_context"]
    )
