...
PDF_OCR_STYLE = {
    ...
    "prompt": "<image>\n<|grounding|>Extract the document content with layout analysis and logical structure markers. Do not add page numbers or external markdown headers.",
    "base_size": 1024,
    "image_size": 640,
    "crop_mode": True,
    "test_compress": True,
...
def main():
    ...
    file_path = "/home/trung-ai/chatbot_hcns/doc/251201_HR-QĐ-005-2025_Quy định chấm công.pdf"
