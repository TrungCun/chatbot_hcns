...
class EvaluatorInsights(BaseModel):
    estimated_seniority: Optional[Literal['Intern','Fresher','Intern/Fresher', 'Junior', 'Mid-level', 'Senior', 'Expert', 'Unknown']] = Field(
        default=None,
    ...
    summary: Optional[str] = Field(
        default=None, description="Đoạn tổng kết chuyên sâu (30-60 từ) cho HR."
    )
